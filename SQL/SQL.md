...
Hãy viết câu lệnh SQL để tạo Database tên là _QuanLyBanHang_ và 3 bảng sau:

 1. Bảng KhachHang (Customers):
 ...
 3. Bảng DonHang (Orders) - Bảng quan trọng nhất:
...
Viết câu lệnh **INSERT** để thêm dữ liệu sau:
 ...
 1. **3 Khách hàng:** "Nguyễn Văn A", "Trần Thị B", "Lê C".
...
Hãy viết câu lệnh **_SELECT_** để trả lời các câu hỏi của chủ cửa hàng:

1. **Câu dễ:** In ra danh sách tất cả sản phẩm có giá từ 15.000 VNĐ trở lên.

2. **Câu trung bình (JOIN):** In ra danh sách các đơn hàng, nhưng thay vì hiện mã số (1, 2, 3), hãy hiện ra Tên Khách Hàng tương ứng.

    _Kết quả mong muốn_: **Mã Đơn** | **Tên Khách** | **Ngày Đặt** | **Tổng Tiền**

3. **Câu khó (Report):** Tính tổng doanh thu mà cửa hàng đã bán được cho khách hàng tên là "Nguyễn Văn A".